...
// export function setMainWindow(win: BaseWindow) {
//     mainWindow = win;
//     if (pendingDeepLink && mainWindow) {
//         const url = pendingDeepLink;
//         pendingDeepLink = null;
//         // Wait for app to fully load before sending IPC
//         mainWindow.contentView.getChildViews()[0].webContents.once('did-finish-load', () => {
//             handleDeepLink(url, mainWindow!);
//         });
//     }
// }

// export function handleDeepLink(pendingDeepLink: string, mainWindow: BaseWindow) {
